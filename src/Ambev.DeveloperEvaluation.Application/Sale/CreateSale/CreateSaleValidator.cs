...
namespace Ambev.DeveloperEvaluation.Application.Sale.CreateSale
{
    ...
    public class CreateSaleCommandValidator : AbstractValidator<CreateSaleCommand>
    {
        ...
        {
            // Validate SaleNumber: must be provided and not exceed 50 characters
            ...
            // Validate SaleDate: must not be in the future
            RuleFor(x => x.SaleDate)
                .LessThanOrEqualTo(DateTime.UtcNow).WithMessage("Sale date cannot be in the future.");

            // Validate CustomerId: must be provided
            RuleFor(x => x.CustomerId)
                .NotEmpty().WithMessage("Customer ID must be provided.");

            // Validate CustomerName: must be provided and not exceed 150 characters
            ...
            // Validate BranchId: must be provided
            RuleFor(x => x.BranchId)
                .NotEmpty().WithMessage("Branch ID must be provided.");

            // Validate BranchName: must be provided and not exceed 150 characters
            ...
            // Validate TotalAmount: must be greater than or equal to zero
